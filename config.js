...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["50937646003"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["50937646003];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(".") : ["50937646003"];
global.OwnerName = process.env.OWNER_NAME || "Darkrush";
